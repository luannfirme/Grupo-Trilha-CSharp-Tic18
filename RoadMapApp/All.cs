...
public static class All
{
      ...
      //             sb.AppendLine();
      //             sb.AppendLine($"Soma geral da Equipe: /*+  LuannFirme.allStars()*/");
      //             return sb.ToString();
      //       }
      ...
      return UserSkills.SelectMany(userSkills => userSkills)
                        ...
                        .Select(groupedSkills => (groupedSkills.Key, groupedSkills.Sum(skill => skill.Item2)))
                        .ToList();
      }

      public static int GetTotalStars()
      {
            return UserSkills.SelectMany(userSkills => userSkills).Sum(skill => skill.Item2);
      }
